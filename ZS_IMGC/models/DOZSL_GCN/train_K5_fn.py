...
class Runner:
    def __init__(self, args):
        ...
        # self.input1, self.adj1 = self.build_graph(node_feats1, 0.95)
        # self.input2, self.adj2 = self.build_graph(node_feats2, 0.95)
        # self.input3, self.adj3 = self.build_graph(node_feats3, 0.95)
        # self.input4, self.adj4 = self.build_graph(node_feats4, 0.9)
        # self.input5, self.adj5 = self.build_graph(node_feats5, 0.95)
