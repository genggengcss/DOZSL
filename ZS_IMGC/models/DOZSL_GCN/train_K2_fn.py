...
class Runner:
    ...
    def extract_disentangled_features(self, args):
        ...
        # # # # ImNet-O
        # if args.DATASET == 'ImageNet/ImNet_O':
        #     embed_file = os.path.join(embed_path, 'KG_ImNet_O/DisenE_TransE_K2_D100_ImNet_O', '3600_3598_ent_embeddings.npy')
        #     entity_file = os.path.join(embed_path, 'KG_ImNet_O/ent2id.txt')
        #
        # # AwA
        # if args.DATASET == 'AwA2':
        ...
        # # ImNet-A
        # if args.DATASET == 'ImageNet/ImNet_A':
        #     embed_file = os.path.join(embed_path, 'KG_ImNet_A/DisenKAGT_TransE_mult_K2_D100_ImNet_A',
        #                               '2400_2356_ent_embeddings.npy')
        #     entity_file = os.path.join(embed_path, 'KG_ImNet_A/ent2id.txt')

        # # ImNet-O
        # if args.DATASET == 'ImageNet/ImNet_O':
        #     embed_file = os.path.join(embed_path, 'KG_ImNet_O/DisenKAGT_TransE_mult_K2_D100_ImNet_O',
        #                               '3000_2980_ent_embeddings.npy')
        #     entity_file = os.path.join(embed_path, 'KG_ImNet_O/ent2id.txt')
